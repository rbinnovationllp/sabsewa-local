-- Run this complete file in the SabSewa Local Supabase SQL Editor.
-- It adds separated Razorpay Test Mode payment-attempt records and
-- idempotent Razorpay webhook audit records.
